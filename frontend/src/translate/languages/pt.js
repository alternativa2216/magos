    ...
    translations: {
      ...
      queues: {
        ...
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage:
            "Você tem certeza? Essa ação não pode ser revertida! Os tickets desses setores continuarão existindo, mas não terão mais nenhum setor atribuído.",
        },
      },
      queueSelect: {
        inputLabel: "Setores",
